...
public class DefaultDateTimeOffsetParserTest {
    ...
    public void ParseIso8601StringProperlyWithQuotingNeeded() {
        var options = CsvOptions.Builder()
            ...
            .WithoutHeaders()
            .Build();
        Assert.That(parser.ParseNext(ContextFrom(options), "\"2023-11-05T13:13:45.1240000+02:00\"").Item1, Is.EqualTo(new DateTimeOffset(2023, 11, 5, 13, 13, 45, 124, TimeSpan.FromHours(2))));
    }
}
